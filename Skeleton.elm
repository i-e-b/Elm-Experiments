...
buttons = flow right . map button <|
  [ ("About"   , "/About.elm"        , (rgb 100 120 130))
  , ("Examples", "/Examples.elm"     , (rgb 100 120 130))
  , ("Docs"    , "/Documentation.elm", (rgb 100 120 130))
  , ("Download", "/Download.elm"     , (rgb 100 120 130)) ]
...
heading outer inner =
  ...
  in  layers <| [ flow down [ color (rgb 200 200 200) (spacer outer 58)
                            , color (rgb 100 100 100) (spacer outer 1) ]
                , header ]
